...
export default function App() {
  ...
  // currentData'nın null hatası TypeError aldığım için, null olmadığı durumlarda showState'i çalıştırmak gerekir
  useEffect(() => {
    if (currentData) {
      ...
      {currentData && (
        ...
        >
          <p
            className="quote"
            style={
              smallestFontSize ? { fontSize: smallestFontSize.fontSize } : {}
            }
          >
